...
#    verificaBanco = "SELECT COUNT([Adversario+data]) FROM BD_INDIVIDUAL;"
#    bancoVerificado = pd.read_sql(verificaBanco, conn)
    
#    query = "SELECT [Adversario+data], [Atleta], [Tempo em jogo], [Nota final], [Nota defensiva], [Nota ofensiva]  FROM BD_INDIVIDUAL;"
